...
namespace GNPXcore{
    ...
    // For simple version:
    //   Not modified for consistency with the Full version.
    ...
    public class GNPXApp000{
        ...
        static public bool      _Loading_ = true;
        ...
        public UPuzzle          pGP{ get=> GNPX_Eng.pGP; }  //current problem is in GNPX_Eng
        ...
        static public int       NiceLoopMax{ get=> GMthdOption["NiceLoopMax"].ToInt(); }
        static public int       ALSSizeMax{  get=> GMthdOption["ALSSizeMax"].ToInt(); }
        static public int       GeneralLogicOn{ get=> GMthdOption["GeneralLogicOn"].ToInt(); }
        ...
        static GNPXApp000( ){
            ...
            GMthdOption["ForceChainCellHouseOn"] = "1";
            ...
            if( SolAll || GNPX_Eng.pGP.DifLevel<=0 || GNPX_Eng.pGP.Name=="" ){
                ...
                if( GNPZ_Engin.retCode<0 ){
                    ...
                    if(GNPX_Eng.pGP.DifLevel<=1 || GNPX_Eng.pGP.Name==""){
                        ...
                        if(GNPX_Eng.pGP.DifLevel<=1)  GNPX_Eng.pGP.DifLevel = difficult;
                        if(GNPX_Eng.pGP.Name=="")     GNPX_Eng.pGP.Name = prbMessage;
                    }
                }
            }     
        ...
        public void SDK_FileOutput( string fName, bool append, bool fType81, bool SolSort, bool SolSet, bool SolSet2 ){
            ...
            using( StreamWriter fpW=new StreamWriter(fName,append,Encoding.UTF8) ){
                foreach( var P in qry ){
                    ...
                    //===== Preparation =====
                    solMessage = "";
                    if(SolSet) solMessage = SetSolution(GP:P,SolSet2:SolSet2,SolAll:SolSet);//output Solution UPuzzle GP, bool SolSet2, bool SolAll=false
...
////            if(GPx.BDL.Any(q=>q.FreeB>0)) 
    ...
    #region SuDoKu Algorithm
        ...
        public void MethodListOutPut( ){
            ...
            WriteLine("#### MethodListOutPut() ... done");
        }
