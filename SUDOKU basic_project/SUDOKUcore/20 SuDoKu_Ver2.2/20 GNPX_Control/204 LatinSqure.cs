...
namespace GNPXcore{
    ...
    public partial class LatinSqureGen{
        ...
        private readonly int[,] U456789  = { {4,5,6,7,8,9}, {4,5,7,6,8,9}, {4,5,8,6,7,9}, {4,5,9,6,7,8}, {4,6,7,5,8,9},
                                             {4,6,8,5,7,9}, {4,6,9,5,7,8}, {4,7,8,5,6,9}, {4,7,9,5,6,8}, {4,8,9,5,6,7} };
        private readonly int[,] U258369  = { {2,5,8,3,6,9}, {2,3,5,6,8,9}, {2,5,6,3,8,9}, {2,5,9,3,6,8}, {2,3,8,5,6,9},
        ...
        public void GeneratePara(ref int[,] pSol99,int s1=0,int s2=0){
            ...
            _LatinSqureSub_01();    // block 2,3, row 1
            _LatinSqureSub_02();    // block 2,3, row 2,3
            
            _LatinSqureSub_11();    // block 4,7, column 1
            _LatinSqureSub_12();    // block 4,7, column 2,3
        ...
        // [2] Calculate the parameters for generating block 2 and 3 (block 4 and 7).
        ...
        // [3] Generate block 2,3 and block 4,7.
        ...
        private void _LatinSqureSub_11( ){     // block 4,7, column 1
            int c=0;
            int px=PLft[0]%10;
        ...
        private void _LatinSqureSub_12( ){      // block 4,7, column 2,3
            int nn,rr=0,rs=0;
            int px=PLft[0]%10;
            int rA=(PLft[0]<10)? 0: 3;
            int rB=3-rA;
