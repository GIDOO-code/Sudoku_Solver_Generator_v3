...
namespace GNPXcore {
    public partial class AnalyzerBaseV2{
        ...
        public List<UCell>   pBDL{ get=>pAnMan.pGP.BDL; }
        public bool          SolInfoB{ get=>pAnMan.SolInfoB; }
        public bool          chbConfirmMultipleCells{ get=> pAnMan.chbConfirmMultipleCells; }
        public int           SolCode{ set=>pAnMan.pGP.SolCode=value; get=>pAnMan.pGP.SolCode; }  
        public string        Result{  set=> pAnMan.Result=value; }
        public string        ResultLong{ set=> pAnMan.ResultLong=value; }
		public string		 extRes{     set=> pAnMan.pGP.extRes=value; get=> pAnMan.pGP.extRes; }
