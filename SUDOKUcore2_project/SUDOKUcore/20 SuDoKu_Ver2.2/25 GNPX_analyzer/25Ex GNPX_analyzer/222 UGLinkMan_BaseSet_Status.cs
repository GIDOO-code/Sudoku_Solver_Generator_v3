...
namespace GNPXcore{
    ...
    public class UGLink_unit{
        ...
        public bool GetGroup_true(Bit981B group){
            return ConnectLinks.Any(P=> group.IsTrue(P&0xF,P>>4));
        }
        public bool GetGroup_false(Bit981B group){
            return ConnectLinks.Any(P=> group.IsFalse(P&0xF,P>>4));
        }
