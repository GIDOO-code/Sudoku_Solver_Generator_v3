...
namespace GNPXcore{
    public class PuzzleTrans{
        ...
        private GNPZ_Engin pGNPX_Eng{ get=> pGNP.GNPX_Eng; }
        public UPuzzle    pGP{ get=>pGNPX_Eng.pGP; }
        public int         ID{ get=>pGP.ID; }

      //===== Transform parameter =====
        private UPuzzle UPorg; //original
        private UPuzzle UPbas;
        public int[]  TrPara;
        private int[,] RCX;
        public  int[] ID_code;
      //----------------------------
