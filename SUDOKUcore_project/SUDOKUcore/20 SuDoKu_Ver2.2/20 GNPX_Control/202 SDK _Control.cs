...
namespace GNPXcore{
    public partial class SDK_Ctrl{    
      ...
      //===== Multiple Solution Analysis ====================
        ...
        static public UPuzzleMan UGPMan=null;
      //---------------------------------------------------
      ...
      //public bool         CbxDspNumRandmize;  //Randomization of numbers
        ...
        static SDK_Ctrl(){
            ...
            MltAnsOption["StartTime"]    = DateTime.Now;
    ...
    #region Generate Puzzle Candidate
        ...
        public List<UCell> GeneratePuzzleCandidate( ){      // Generate puzzle candidate
            int[]  P=GenSolPatternsListA(SDK_Ctrl.NumRandmize, GenLStyp); //*****
        ...
        public void SDK_ProblemMakerReal( CancellationToken ct ){ //Creating problems[Automatic]
            try{
                ...
                do{
                    ...
                    LoopCC++; TLoopCC++;
                    List<UCell>   BDL = GeneratePuzzleCandidate( );  // Generate problem candidate.
                    UPuzzle P = new UPuzzle(BDL);
                    pGNPX_Eng.SetGP(P);

                    pGNPX_Eng.AnalyzerCounterReset();
                    pGNPX_Eng.sudokAnalyzerAuto(ct);        // Apply algorithms to candidate and try to solve them.
