...
namespace GNPXcore{
    public partial class SDK_Ctrl{
            ...
            if(rxCTRL<=0 || LSlst==null || LSUcc>=LSlst.Count){
                ...
                do{
                    ...
                    foreach( var P in GenerateLatinSqure0A(RandF:RandF) ){
                        ...
                        { // Aggregate the same problems after applying the pattern
                            if(Q==null){ 
                                LSlst.Add(P); Q=P;
                            ...
                            // List<int[]> is not required to detect that Sudoku is a multiple solution.
                            Q.Sol99lst.Add(S99);    // Count Latin_Square with the same hash value.
                            Q.cnt++;    
                        }
                    }
                    LSUcc=0;
        ...
        //Å@2) Overlay windows and convert to problems
                ...
                while(prm.Successor(nxtX)){                         //Fill blocks 5,6,8,9 to generate latinSol99(latin square)
                    ...
                    if(RX<8){
                     ...
                     //   __DBUGprint2(Sol99, "Sol99 "+q.ToString()+" ");
                        ...
                        if(RandF) _DspNumRandmize(SolX);                // 3)Randamize
        ...
        public class _LSpattern{
            ...
            public int    cnt=0;
            public _LSpattern(uint hashVal, int[] SolX, int[,] Sol99){
                this.hashVal=hashVal; this.SolX=SolX; this.Sol99=Sol99;
            }
        }
